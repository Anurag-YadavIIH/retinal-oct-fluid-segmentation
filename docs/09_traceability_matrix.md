...
The ten `URS` rows carry no allocation yet: `docs/01` is drafted but `docs/02`,
...
- User requirements with at least one software requirement: **0 of 10** — `docs/01`
  allocates URS-001..URS-010, `docs/02` does not yet exist. This is the milestone 2 gap.
